...
public abstract class LineBasedImporterBase extends URIImporter {
	 ...
	 * 
	 * If you override this then you should also override {@link #getPassesNeededToComputeColumnCount(ObjectNode)}
	 * which predicts how many scans of the dataset will be required to run this method.
	 * 
	...
	/**
	 * Returns the number of passes done on the dataset when computing the column count.
	 * Override this if you override {@link #getColumnCount(GridState, RowMapper, ObjectNode)} 
	 * so that progress reporting is appropriately adapted.
	 * 
	 * @param rawCells
	 * @param rowMapper
	 * @param options
	...
	/**
	 * Utility class to report progress in a scaled fashion, when we
	 * know how many passes on the file we will need to do.
	 * 
	 * @author Antonin Delpeuch
	 *
	 */
