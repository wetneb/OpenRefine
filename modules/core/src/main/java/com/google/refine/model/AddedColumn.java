...
/**
 * A column added by an operation, part of a {@link ColumnDiff}.
 * <br>
 * Supplying the name of the column it is inserted after makes it possible to pre-compute
 * the order of the columns in the resulting grid, which is useful for visualization purposes.
 */
public class AddedColumn {
     ...
     * @param afterName optionally, the name of the column to its left, specifying the insertion point of the column. Otherwise, null.
     */
